...
export default function Timeline() {
  ...
  return (
    <section id="architecture" className="py-20 border-t border-[#E2E8F0]">
      <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div>
            ...
            <h2 className="mt-4 text-3xl font-extrabold tracking-tight text-[#0F172A]">
          ...
          <div className="space-y-2.5">
            {coreCompetencies.map((skill, index) => (
              <div key={index} className="flex items-center gap-3 p-3 bg-white border border-[#E2E8F0] rounded-xl shadow-sm text-xs font-semibold text-[#334155]">
        ...
        <div id="timeline" className="lg:col-span-7 space-y-6">
          ...
          <div className="relative border-l-2 border-[#E2E8F0] ml-4 pl-6 space-y-8">
            {timelineEvents.map((event, index) => (
              <div key={index} className="relative group">
                {/* Timeline Node Dot */}
                <span className="absolute -left-[31px] top-1 flex h-4 w-4 rounded-full border-2 border-[#2563EB] bg-white group-hover:bg-[#2563EB] transition-colors duration-200" />
                
                <div className="p-5 bg-white border border-[#E2E8F0] rounded-xl shadow-sm hover:shadow-md transition-all">
                  <span className="text-xs font-bold text-[#2563EB]">
                    {event.year}
                  </span>
                  <h4 className="text-base font-bold text-[#0F172A] mt-1 group-hover:text-[#2563EB] transition-colors">
                    {event.title}
                  </h4>
